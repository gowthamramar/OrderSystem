 ...
 * Project ClickKart
 */
public class StoreVegetablesRecyclerViewAdapter extends RecyclerView.Adapter<StoreVegetablesRecyclerViewAdapter.ViewHolder> {
    Dialog dialog;
    List<VegetablesBean> vegetablesRecyclerItems=new ArrayList<>();
    StoreActivity storeActivity;
    CustomTextView productQuantity,productName;
    int quantity;
    HomePastOrderAdapterListener homePastOrderAdapterListener;
    public StoreVegetablesRecyclerViewAdapter(ArrayList<VegetablesBean> vegetablesRecyclerItems, StoreActivity storeActivity) {
        this.vegetablesRecyclerItems=vegetablesRecyclerItems;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int i) {
        Glide.with(storeActivity).load(vegetablesRecyclerItems.get(i).getImage())
                .apply(RequestOptions.circleCropTransform())
                .into( holder.pastOrderImageview);
       /* holder.pastOrderImageview.setImageResource(vegetablesRecyclerItems.get(i).getImage());*/
        holder.price.setText(vegetablesRecyclerItems.get(i).getPrice());
        holder.offerPrice.setText(vegetablesRecyclerItems.get(i).getOfferPrice());
        holder.productName.setText(vegetablesRecyclerItems.get(i).getProductName());
        holder.product_plus_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              productName.setText(vegetablesRecyclerItems.get(i).getProductName());
                Glide.with(storeActivity)
                        .load(vegetablesRecyclerItems.get(i).getImage())
                        .apply(RequestOptions.circleCropTransform())
    ...
    public int getItemCount() {
        return vegetablesRecyclerItems.size();
    }
