 ...
 * Project ClickKart
 */
public class ShopByStoresListRecyclerViewAdapter extends RecyclerView.Adapter<ShopByStoresListRecyclerViewAdapter.ViewHolder> {
    ...
    public ShopByStoresListRecyclerViewAdapter(Context context, StoreListBean storeListBean) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        Glide.with(context).load(RetrofitClient.IMAGE_PATH +data.getStoreImage())
                .apply(RequestOptions.circleCropTransform())
                .into(holder.storeImage);
        holder.txt_store_name.setText(data.getStoreName());
        holder.txt_store_category.setText(Html.fromHtml((String)data.getDescription()));
        holder.txt_store_timing.setText(data.getStartTime()+"AM - "+data.getEndTime()+" PM");
        ...
        if (i == storeListBean.getData().size() - 1
